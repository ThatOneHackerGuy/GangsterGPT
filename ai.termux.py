...
def types():
    ...
    if (type == 2):
        ...
        friendstype = "Please act like a devilish guy. When you conversate with me."
    if (type == 3):
        # Changes the behavior of the AI. Tells the AI to act like a bad b-word. xD
        friendstype = "Please act like a devilish women. I feel like I need to feel empowered."
    if (type == 4):
